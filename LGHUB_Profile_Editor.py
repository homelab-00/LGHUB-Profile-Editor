...
# -------------------------------------------------------------
# Note: Same as "GHUB_A6IB3(A).py", renamed for distribution.
...
def load_or_create_config():
    """
    Tries to load the config from 'ghub_db_location_config.json'.
...
def save_config(cfg):
    """
    Overwrites the entire config object to 'ghub_db_location_config.json'.
    """
    config_path = get_config_path()
    try:
        with open(config_path, "w", encoding="utf-8") as f:
